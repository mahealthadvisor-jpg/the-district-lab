        ...
        {events.map((e) => {
          ...
          return (
            <button
              ...
              className={`w-full pl-2 pr-3 py-2 rounded-lg shadow-md hover:bg-slate-900 transition-colors text-left flex flex-col gap-1 ${
                isActive ? "bg-slate-900 ring-1 ring-slate-700" : "bg-slate-950"
              }`}
            ...
            >
              ...
              {e.comment && (
                <div className="text-[10px] text-slate-300 italic line-clamp-2 leading-snug">
                  {e.comment}
                </div>
              )}
            </button>
